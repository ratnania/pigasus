...
contains
    ...
    subroutine build_advection_Local(ao_ASS, ao_FEM, ai_grids_id, ai_id, ai_elt, ai_ref, apr_Operator_elt)
        implicit none
...
!        li_parameval   = ao_FEM % opi_InfoOperator(ai_ref, INFOOPERATOR_PARAMEVAL)
...
!print*,'apr_Operator_elt',apr_Operator_elt
!STOP
#ifdef _PERF        
