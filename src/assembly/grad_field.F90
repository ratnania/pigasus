...
contains
    ...
    !----------------------------------------------------------------------------------------------
    subroutine build_grad_field_Local(ao_ASS, ao_FEM, ai_grids_id, ai_id, ai_elt, ai_field, apr_fieldh)
        implicit none
...
#ifdef _DEBUG        
        call printlog("build_grad_field_Local : Begin", ai_dtllevel = mi_dtllevel_base + 1)
#endif
!print *, 'ai_elt=', ai_elt
...
!        li_nparam   = ao_FEM % opi_InfoField(ai_field, INFOFIELD_NPARAM )
        ...
        print *, 'F(1,:) = ', apr_fieldh(ai_field,1,1, 1:li_npts)
        print *, 'F(2,:) = ', apr_fieldh(ai_field,1,2, 1:li_npts)

#ifdef _DEBUG        
        call printlog("build_grad_field_Local : End", ai_dtllevel = mi_dtllevel_base + 1)
#endif
    end subroutine build_grad_field_Local

end module grad_field_module
